...
public class UserServiceTest {
	...
	@Mock
	private CsvEntryRepository userRepository;

	@Mock
	private ThirdyPartyApiClient thirdyPartyApiClient;

	@Captor
	private ArgumentCaptor<List<CsvEntry>> capturedUsers;
	...
	private List<CsvEntry> getApiUsers() {
		return Lists.newArrayList(
				new CsvEntry().setAge(AGE).setHeight(HEIGHT).setName(NAME).setRequestStatus(RequestStatus.HOLDNG));
	}
